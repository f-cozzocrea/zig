//! C compiler builtin functions. These functions exist for use by zig code generated by
//! translate-c, and should not be called by user code.
...
/// Returns the absolute value of and integer `val`. Replicates Standard C Library bug:
...
/// Returns the absolute value of floating type `val`.
